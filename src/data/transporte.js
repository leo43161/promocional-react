...
export const DESTINOS = {
    ...
    sur: ['Simoca', 'La cocha', 'Lules', 'Famaillá', 'Monteros', 'Concepción', 'Alberdi', 'Bella Vista', 'Rio Colorado', 'Atahona', 'Monteagudo', 'Lamadrid', 'Taco Ralo', 'Samay Cochuna'],
    valles: ['El Mollar', 'Tafi del Valle', 'Amaicha del Valle', 'Colalao del Valle', 'Cafayate'], // Key matches CIRCUITOS id
    yungas: ['Yerba Buena', 'Tafi Viejo', 'Primera Confitería', 'Horco Molle', 'San Javier', 'Raco y El Siambón', 'El Cadillal y Rio Loro']
};
