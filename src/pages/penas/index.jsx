...
export default function PeñasPage() {
  ...
  const { data, error, isLoading } = useGetlistaCardsQuery(PEÑAS_ID);
  ...
  if (isLoading) {
    return (
      <div className="text-center text-lg mt-10">Cargando Peñas...</div>
    );
  }
    ...
    <div>
      <section>
        <ParallaxContainer
          ...
          className=""
          imageUrl="https://www.tucumanturismo.gob.ar/public/img/peñasgaleria4_8w8xs0bg_11-06-2024_fqyowmxz_17-07-2025.jpg"
        >
          <div className="container mx-auto h-full text-white flex flex-col justify-end">
            <div className="w-11/12 mx-auto pt-5">
              <h2 className="text-5xl md:text-6xl font-bold mb-6">Peñas</h2>
            </div>
          </div>
        </ParallaxContainer>
      </section>
      <div className="w-11/12 mx-auto pt-5">
        <div className="mb-5">
          <Breadcrumb
            items={[{ label: "Peñas", href: "/penas" }]}
          ></Breadcrumb>
        </div>
        <div className="container mt-5">
          <h1 className="text-center mb-4 text-3xl font-semibold">
            Peñas de la provincia de Tucumán
          </h1>
        </div>
