...
export default function MuseosPage() {
  ...
  const { data, error, isLoading } = useGetlistaCardsQuery(MUSEOS_ID);
  ...
  if (isLoading) {
    return (
      <div className="text-center text-lg mt-10">Cargando Museos...</div>
    );
  }
    ...
    <div>
      <section>
        <ParallaxContainer
          ...
          className=""
          imageUrl="https://www.tucumanturismo.gob.ar/public/img/casahistorica_nl4vn8fy_16-07-2025.jpg"
        >
          <div className="container mx-auto h-full text-white flex flex-col justify-end">
            <div className="w-11/12 mx-auto pt-5">
              <h2 className="text-5xl md:text-6xl font-bold mb-6">Museos</h2>
            </div>
          </div>
        </ParallaxContainer>
      </section>
      <div className="w-11/12 mx-auto pt-5">
        <div className="mb-5">
          <Breadcrumb
            items={[{ label: "Museos", href: "/museos" }]}
          ></Breadcrumb>
        </div>
        <div className="container mt-5">
          <h1 className="text-center mb-4 text-3xl font-semibold">
            Museos de informes de la provincia de Tucumán
          </h1>
        </div>
