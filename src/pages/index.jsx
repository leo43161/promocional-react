...
export default function index() {
  ...
  return (
    <div>
      ...
      <div className='md:w-11/13 w-full mx-auto md:mb-30 mb-15'>
        <Planifica></Planifica>
      </div>
      <div className='mb-20'>
        <Entumesa></Entumesa>
      </div>
      <div className='md:w-11/13 w-full mx-auto mb-20'>
      ...
      <a target='_blank' href='https://teatromercedessosa.com/'>
        <img src={`${process.env.URL_LOCAL_SERVER}${process.env.URL_LOCAL}/images/banners/TeatroMercedesSosa-desktop.jpg`} alt="" />
      </a>
      </div>
