...
export default function FestivalesPage() {
    const FESTIVALES_ID = 5;
    const { data, error, isLoading } = useGetlistaCardsQuery(FESTIVALES_ID);
    ...
    if (isLoading) {
        return (
            <div className="text-center text-lg mt-10">Cargando Fiestas y Festivales....</div>
        );
    }

    if (error) {
        console.error("Error fetching Fiestas y Festivales:", error);
        return (
        ...
        <div>
            <section>
                <ParallaxContainer
                    ...
                    className=""
                    imageUrl="https://www.tucumanturismo.gob.ar/public/img/feria simoca año 2019 (53)_k6wdnfo2_18-07-2025.jpg"
                >
                    <div className="container mx-auto h-full text-white flex flex-col justify-end">
                        <div className="w-11/12 mx-auto pt-5">
                            <h2 className="text-5xl md:text-6xl font-bold mb-6">Fiestas y Festivales</h2>
                        </div>
                    </div>
                </ParallaxContainer>
            </section>
            <div className="w-11/12 mx-auto pt-5">
                <div className="mb-5">
                    <Breadcrumb items={[{ label: "Fiestas y Festivales", href: "/festivales" }]}></Breadcrumb>
                </div>

                <div className="container mt-5">
                    <h1 className="text-center mb-4 text-3xl font-semibold">
                        Fiestas y Festivales de nuestra provincia
                    </h1>
                </div>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {articulos.length > 0 ? (
                        ...
                        <div className="col-span-full text-center text-muted">
                            No se encontraron Fiestas y Festivales.
                        </div>
                    )}
                </div>
            </div>
