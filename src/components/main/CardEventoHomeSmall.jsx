...
export default function CardEventoHomeSmall({ evento }) {
        ...
        <div className='w-full overflow-hidden shadow'>
            <div className='flex flex-col h-full items-stretch'>
                <div className='relative h-60'>
                    ...
                    />
                    <div className='rounded-b-md absolute top-0 left-8 shadow-lg bg-primary text-zinc-50 w-auto py-1 px-3 flex justify-center'>
                        <h4 className='font-bold text-[1.1em]'>{displayDate}</h4>
                    </div>
                    <div className='flex-col flex gap-1 py-2.5 px-4 absolute bottom-0 bg-gradient-to-t from-black/70 via-black/50 via-70% to-transparent text-zinc-50 w-full'>
                        <h3 className='font-bold text-left text-4xl line-clamp-1 text-shadow-lg'>{nombre}</h3>
                        <div className='flex items-center gap-1.5'>
                            <div>
                                <Clock className='font-bold text-lg' size={17} />
                            </div>
                            <span className='text-[1.2em]'>{formattedTime}</span>
                        </div>
                        <div className='flex items-center gap-1.5'>
                            <div>
                                <MapPin className='font-bold text-lg' size={17} />
                            </div>
                            <span className='text-[1.2em]'>{direccion} - {nombreLocalidad}</span>
                        </div>
                    </div>
                </div>
                {/* <div>
